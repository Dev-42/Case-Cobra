...
// Use StaticImageData type for image handling
const PHONES = [phone1, phone2, phone3, phone4, phone5, phone6]

// Utility function to split an array into multiple parts
...
function ReviewColumn({
  ...
  reviews: (string | StaticImageData)[] // Updated to handle StaticImageData
  className?: string
...
interface ReviewProps extends HTMLAttributes<HTMLDivElement> {
  imgSrc: string | StaticImageData // Updated type
}
