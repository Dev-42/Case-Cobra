...
const Navbar = async() => {
    ...
    // console.log(isAdmin)
  return (
    <nav className='z-100 sticky h-[4.5rem] inset-x-0 top-0 w-full border-b border-gray-200 bg-white/75 backdrop-blur-lg transition-all'>
        <MaxWidthWrapper>
            <div className='flex h-[4.5rem] items-center justify-between border-zinc-200'>
